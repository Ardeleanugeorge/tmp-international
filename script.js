...
document.querySelectorAll('.serviciu-card, .feature-box, .tara-card, .contact-info, .contact-form').forEach(el => {
    el.style.opacity = '0';
...
if (heroVideo) {
    ...
    // Try on any user interaction (touch, scroll, click, etc.)
    ...
    document.addEventListener('touchend', startOnInteraction, { once: true, passive: true });
